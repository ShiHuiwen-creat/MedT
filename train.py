...
from metrics import jaccard_index, f1_score, LogNLLLoss,classwise_f1,SoftDiceLoss,Focal_Loss,DiceLoss,BinaryDiceLoss,FocalLoss,focal_loss
...
# python train.py --train_dataset "./TrainFolder/" --val_dataset "./TestFolder" --direc "./results/axial128_en/" --batch_size 4 --modelname "logo" --epoch 10 --save_freq 50 --learning_rate 0.001 --imgsize 128
...
# python test.py --train_dataset "./TrainFolder/" --loaddirec "./results/axial128_en/final_model.pth" --val_dataset "./TestFolder/img" --direc './TestFolder/result' --batch_size 4 --modelname "logo" --imgsize 128 --gray "no"
# python train.py --train_dataset "./train" --val_dataset "./TestFolder" --direc "./results/axial1354_en/" --batch_size 4 --modelname "logo" --epoch 10 --save_freq 50 --learning_rate 0.001 --imgsize 128
